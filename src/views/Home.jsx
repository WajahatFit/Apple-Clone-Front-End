  ...
  return (
    <div className="font-sans">
      <section id='iPhone' className="flex flex-col mx-auto bg-balck">
        <div className="flex flex-col bg-black items-center tracking-widest md:p-4 p-6">
          <div class="text-5xl md:text-6xl md:text-center lg:text-8xl md:py-4 lg:text-center font-extrabold mt-8 p-4">
          ...
          <h1 className="text-3xl md:text-3xl md:text-center lg:text-4xl lg:text-center text-center text-lightGray bg-black mt-10 font-semibold ">
            iPhone 14 PRO
                  ...
                  <div className="flex flex-row justify-center mx-auto space-x-8 p-6 ">
          ...
          <section id='multiSec' className="bg-white flex flex-col items-center md:flex-row bg-lightWhite">
          ...
          <h1 className="text-3xl md:text-3xl md:text-center lg:text-4xl lg:text-center text-center m-10 font-semibold ">
            Make your day to day payments with Apple Card.
              ...
              <div className="flex flex-col bg-lightWhite items-center tracking-widest h-full w-full md:w-1/2">
          <div class="text-5xl md:text-6xl md:text-center lg:text-8xl lg:text-center font-extrabold mt-12">
            <span class=" bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-orange-600">
            Orangee Store 
                      </span>
          </div>
          <h1 className="text-3xl md:text-3xl md:text-center lg:text-4xl lg:text-center text-center m-10 font-semibold ">
            Upcoming Sale on 24 Feb
                  ...
                  <div className="flex flex-row justify-center mx-auto space-x-8">
                      <Link to='/about'><h1 className="text-sky-500 text-2xl md:text-3xl lg:text-4xl hover:underline hover:underline-offset-2">Our mission {">"}</h1></Link>
                      
          </div>
                  <img className="w-full md:w-2/6 mt-8 md:mb-8" src={logo} alt="airpods" />
        </div>
          </section>
          <Footer />
    </div>
